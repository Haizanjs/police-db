...
<html lang="en-US">
	<head>
		...
		<!-- Meta -->
		<meta charset="UTF-8">
		<title><?php echo $cminfo['pda']; ?> - Training Reports</title>
		<meta name="description" content="<?php echo $cminfo['pdn']; ?> - Training Reports">
					...
					<div class="row">
						<div class="col-12">
							<article class="inner">
								<div class="row">
									<div class="col-12">
										<h4>Add Training Report:</h4>
                                       	<form id="post-comment" class="inner" action="report_data.php" method="post">
										<div class="row">
                                        ...
                                        <h7>If you seek help with submitting data, contact High Command.</h7>
									</div>
								</div>
							</article>
						</div>
